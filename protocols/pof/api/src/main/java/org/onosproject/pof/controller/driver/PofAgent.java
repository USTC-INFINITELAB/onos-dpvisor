...
public interface PofAgent {
     ...
     */
    boolean addConnectedSwitch(Dpid dpid, PofSwitch sw);
     ...
     * @return true if added, false otherwise.
     */
    void handleConnectionUp(Dpid dpid, PofSwitch sw);
     ...
     * @return true if added, false otherwise.
     */
    boolean addActivatedMasterSwitch(Dpid dpid, PofSwitch sw);
     ...
     * @return true if added, false otherwise.
     */
    boolean addActivatedEqualSwitch(Dpid dpid, PofSwitch sw);
