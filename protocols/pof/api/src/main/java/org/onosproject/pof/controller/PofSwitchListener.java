...
//import org.projectfloodlight.openflow.protocol.OFPortStatus;//wenjian
 ...
 */
public interface PofSwitchListener {
    ...
    //added by hdy to add table resource
    void setTableResource(Dpid dpid, OFFlowTableResource msg);
    /**
