...
/**
 * Tests for packet processing in the abstract Pof switch class.
 */
public class AbstractPofSwitchTest {

    PofSwitchImpl ofSwitch;
    ...
    static class TestExecutorService extends ExecutorServiceAdapter {
        ...
        public void execute(Runnable task) {
            AbstractPofSwitch.OFMessageHandler handler =
                    (AbstractPofSwitch.OFMessageHandler) task;
    ...
    public void setUp() {
        ...
        ofSwitch.addEventListener(new PofEventListenerAdapter());
    }
    ...
    public void testStatsRequest() {
        OFMessage ofStatsRequest = new MockOfMultipartRequest();
        ofSwitch.sendMsg(ofStatsRequest);
        assertThat(executorService.submittedMessages(), hasSize(1));
        assertThat(executorService.submittedMessages().get(0), is(ofStatsRequest));
    }

    protected class PofSwitchImpl extends AbstractPofSwitch {
    ...
    private class PofEventListenerAdapter implements PofEventListener {
